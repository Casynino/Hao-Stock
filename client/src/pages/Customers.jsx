      ...
      {isLoading || !data ? <PageSpinner /> : (
        <div className="space-y-4 text-sm">
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="rounded-lg bg-rose-50 p-3"><div className="text-xs text-muted">Owes</div><div className="text-lg font-bold text-rose-600">{formatCurrency(data.stats.outstandingDebt)}</div></div>
          </div>
